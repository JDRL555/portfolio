...
<template>
  <SectionLayout :title="title">
    <div class="relative h-[500px] w-full max-w-6xl mx-auto flex items-center justify-center perspective-1000 pt-10">
      <div 
        v-for="(exp, index) in experiences"
        :key="index"
        class="absolute w-[380px] md:w-[450px] bg-white rounded-3xl shadow-xl p-8 cursor-pointer transition-all duration-500 ease-out border border-blue-100 flex flex-col h-[600px]"
